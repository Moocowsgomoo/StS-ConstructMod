...
public class OrbAssault extends AbstractConstructCard {
	...
	private static final int UPGRADE_POWER_DAMAGE = 2;
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		AbstractDungeon.actionManager.addToBottom(new MakeTempCardInDrawPileAction(p,p, new BrokenOrb(),this.numOrbs,true,false));
