...
public class Implosion extends AbstractConstructCard {
	...
	public static final int UPGRADE_NEW_COST = 0;
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		AbstractDungeon.actionManager.addToBottom(new ImplosionAction(this.megaUpgraded));
	}
	...
	public void applyPowers(){
		...
		this.rawDescription = EXTENDED_DESCRIPTION[0] +
				(this.megaUpgraded?getBurnInPile(AbstractDungeon.player.drawPile)+ EXTENDED_DESCRIPTION[1]:"") +
				getBurnInPile(AbstractDungeon.player.discardPile)+ EXTENDED_DESCRIPTION[2]+desc;
