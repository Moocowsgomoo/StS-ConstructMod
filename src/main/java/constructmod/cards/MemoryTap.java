...
public class MemoryTap extends AbstractConstructCard {
	public static final String ID = ConstructMod.makeID("MemoryTap");
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		...
		for (int i=0;i<(this.megaUpgraded?2:1);i++) {
			...
			AbstractCard c1;
			do {
				c1 = CardLibrary.getRandomColorSpecificCard(CardColor.RED, AbstractDungeon.cardRandomRng).makeCopy();
			...
			AbstractCard c2;
			do {
				c2 = CardLibrary.getRandomColorSpecificCard(CardColor.GREEN, AbstractDungeon.cardRandomRng).makeCopy();
			...
			AbstractCard c3;
			do {
				c3 = CardLibrary.getRandomColorSpecificCard(CardColor.BLUE, AbstractDungeon.cardRandomRng).makeCopy();
