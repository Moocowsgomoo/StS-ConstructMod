...
public class CoreShard extends AbstractCycleCard {
	...
	public CoreShard() {
		super(ID, NAME, "img/cards/"+"CoreStorm"+".png", COST, DESCRIPTION, AbstractCard.CardType.STATUS,
				CardColor.COLORLESS, AbstractCard.CardRarity.BASIC, AbstractCard.CardTarget.NONE, POOL);
